...
procedure TFrmPergunta2.FormShow(Sender: TObject);
   begin
      ...
      tempo2.Enabled :=true; // Estamos habilitando o tempo para o usuário responder
      dtm.hora := strtotime('00:00:00'); // Variável hora recebe o tempo zerado
   end;

procedure TFrmPergunta2.RdgResposta2Click(Sender: TObject);
begin
tempo2.Enabled :=false; // Se o usuário respondeu, a contagem é desfeita desabilitando o timer tempo1
