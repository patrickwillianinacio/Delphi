...
begin
  ...
  IdSMTP1.Username := 'patrickinacio@gmail.com';
  IdSMTP1.Password := 'patrick97726517';
  ...
  IdMessage1.From.Address := 'patrickinacio@gmail.com';
  IdMessage1.From.Name := 'Eu';
  IdMessage1.ReplyTo.EMailAddresses := IdMessage1.From.Address;
  IdMessage1.Recipients.Clear;
  IdMessage1.Recipients.EMailAddresses := 'patrick@unimedrioclaro.com.br';
