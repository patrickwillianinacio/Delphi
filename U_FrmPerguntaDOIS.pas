...
uses U_FrmPerguntaUM, U_DTM, U_FrmPerguntaTRES;
...
procedure TFrmPergunta2.RdgResposta1Click(Sender: TObject);
   begin
     tempo1.Enabled :=false; // Se o usuário respondeu, a contagem é desfeita desabilitando o timer tempo1
   if RdgResposta1.itemindex =0 then // Se o usuário clicou na resposta certa
      begin
     ...
     RdgResposta1.Enabled :=false; // As respostas são desabilitadas
...
procedure TFrmPergunta2.BtnAvancarClick(Sender: TObject);
   begin
     FrmPergunta3.showmodal
   end;
